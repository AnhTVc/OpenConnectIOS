 ...
 */
- (void)openVPNAdapter:(OpenAdapter *)openVPNAdapter
 ...
 */
- (void)openVPNAdapter:(OpenAdapter *)openVPNAdapter handleError:(NSError *)error;
 ...
 */
- (void)openVPNAdapter:(OpenAdapter *)openVPNAdapter handleLogMessage:(NSString *)logMessage;
 ...
 */
- (void)openVPNAdapterDidReceiveClockTick:(OpenAdapter *)openVPNAdapter;
