...
typedef  struct Routes{
     ...
     __unsafe_unretained NSString *netmask;
     __unsafe_unretained NSString *gateway;
} Routes;
typedef struct SettingVPN{
    __unsafe_unretained NSString *mtu;
    __unsafe_unretained NSString *server;
    __unsafe_unretained NSString *port;
    __unsafe_unretained NSString *ipClient;
    __unsafe_unretained NSString *subnetClient;
    __unsafe_unretained NSArray *dns;
    Routes *routes;
    //__unsafe_unretained NSArray *routes;
}SettingVPN;
